...
publisher1 = Publisher.create(:name => "Publisher 1")
...
janet_book_1 = Book.create(:title => "Janet's First Book", :publisher_id => publisher1.id, :author_id => janet_silva.id)
janet_book_2 = Book.create(:title => "Janet's Second Book", :publisher_id => publisher1.id, :author_id => janet_silva.id)
janet_book_3 = Book.create(:title => "Janet's Third Book", :publisher_id => publisher1.id, :author_id => janet_silva.id)
janet_book_4 = Book.create(:title => "Janet's Fourth Book", :publisher_id => publisher1.id, :author_id => janet_silva.id)
